...
[`st_trace-matrix`](https://github.com/mjfrigaard/moviesApp/tree/st_trace-matrix) gives examples of creating a traceability matrix with [`covtracer`](https://genentech.github.io/covtracer/)

## Tests 

The structure of the `tests/` directory in this branch is below: 
